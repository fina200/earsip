                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-list-alt"></i> <a  href="{{ url('pengirim_surat') }}" >Pengirim Surat</a>
                        </ul>
                        <li>
                            <a href="{{ url('arsip_surat') }}"> <i class="menu-icon ti-email"></i>Arsip Surat </a>
                        </li>
                        <a class=" btn btn-danger .btn-sm " button style="margin-right: 10px;" href="{{ route('login') }} " role="button" onclick="return confirm ('Apakah anda yakin ingin keluar dari halaman Administrator?')">Log Out</a>
                    <a class="btn btn-danger .btn-sm" href="../index.php" role="button" onclick="return confirm ('Apakah anda yakin ingin keluar dari halaman Administrator?')">Daftar Tamu</a>
                        </ul>
                    </li>
                    @endif
                </ul>
