...
@section('tamuumum')
    <div class="card mt-2 ">
        ...
        <div class="card-body ">
            <form method = "post" action = "{{ url("tamuumum/$dataedit->id") }}">
                @method('put')
                @csrf
                <div class="form-group ">
                    <label for="nama">Nama</label>
                    <input type="text" class="form-control" id="nama" name="nama" required class = "form-control"value="{{ $dataedit->nama }}">
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="tujuan" name="tujuan" required
                        class = "form-control"value="{{ $dataedit->tujuan }}">
                </div>
